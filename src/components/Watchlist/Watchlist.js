...
const Watchlist = () => {
  return (
    <div className={`container-fluid ${styles.watchlistSize}`}>
      <div className={`row ${styles.watchlist} ${styles.titleContainer}`}>
        <div className="col-md-12">
          <span className={`${styles.watchlistHeader}`}>Watchlist</span>
        </div>
      </div>
      <div className={`row ${styles.watchlist} ${styles.toolbarContainer}`}>
        <div className="col-md-12">
      ...
      <div className={`row ${styles.watchlist} ${styles.tableContainer}`}>
        <div className="col-md-12">
          <div>
